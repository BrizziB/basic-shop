...
public abstract class JPATest {
    ...
    public void setup() throws IllegalAccessException {
        ...
        entityManager.createNativeQuery
                ...
                .executeUpdate();                       		// da HSQLDB 2.2.6 in poi - ripulisce il DB mantenendo le tabelle
        ...
        init();                                         		// sar� definito nelle specializzazioni
        entityManager.getTransaction().commit();        		// chiudo la transazione relativa ad init()
        entityManager.clear();                          		// ripulisco EM da eventuali entit� rimaste appese
        entityManager.getTransaction().begin();         		// avvio la transazione per l'uso che sar� fatto dal metodo di Test
